...
def train(dataset_len, data_dim, training_data,model_name, Flags):
    ...
    with tf.device("/cpu:0"):
        ...
        model = modeldefault.VariationalAutoencoderModel(hl_int_list,model_name, data_dim, dataset_len, int(dim_z), int(ft), mode=mode, verbose=True,modeldir=Flags.modeldir,quantised=Flags.quantised)
